  ...
  return (
    <div className="min-h-screen bg-[#cbf2fe]">
      ...
      <div className="flex bg-[#cbf2fe] p-2 border-b-2 border-[#1887b6]">
        ...
        {/* Navigation and login column - width 650px */}
        <div className="w-[650px] bg-[#cbf2fe] flex flex-col">
          ...
          {/* Login form row */}
          <form name="login" action="/" method="post" className="flex items-center gap-2 text-black">
            <label>
              <b>Username</b>
              <input id="login_username" name="login_username" type="text" className="ml-2 border px-1 py-0.5 rounded" />
            </label>
            <label>
              <b>Password</b>
              <input id="login_password" name="login_pass" type="password" className="ml-2 border px-1 py-0.5 rounded" />
            </label>
            <button
              type="button"
              onClick={() => {
                ...
                if ((window as any).initLogin) (window as any).initLogin(username, password)
              }}
            >
              <Image src="/graphics/visit_log_in.gif" alt="Login" width={60} height={20} className="max-w-full h-auto" />
            </button>
            <Link href="/townhall/support">
              <span className="text-sm text-black ml-2">[ forgot your password? ]</span>
            </Link>
          </form>
        </div>
      </div>
      ...
      {/* SEARCH BAR */}
      <div className="bg-[#1887b6] px-2 py-1">
        <form name="search" action="/site_search" method="get">
          <div className="flex items-center gap-2 text-white">
            ...
            <input type="text" name="search" className="px-1 py-1 border rounded text-black" />
            <button type="submit" className="p-0">
              <Image src="/graphics/visit_go.gif" alt="Search" width={40} height={25} className="max-w-full h-auto" />
            </button>
          </div>
        </form>
      </div>
      ...
      <div className="grid grid-cols-[150px_650px_275px] min-h-[calc(100vh-150px)]">
